...
public class section_17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_section17);
    ...
    public void toLaw1(View v) {
        pass_law_ra = getString(R.string.sec_17_law_ra_1);
        pass_law_name = getString(R.string.sec_17_law_name_1);
        pass_law_chap = getString(R.string.sec_17_law_chap_1);
        pass_law_chapsub = getString(R.string.sec_17_law_chapsub_1);
        pass_law_section = getString(R.string.sec_17_law_section_1);
        pass_law_secsub = getString(R.string.sec_17_law_secsub_1);
        pass_law_content = getString(R.string.sec_17_law_content_1);
        ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(this);
        Intent intent = new Intent(getApplicationContext(), law_model_incomplete.class);
        intent.putExtra("activity", "section_17");
